      ...
      >
        <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl p-8">
          ...
          <div className="flex justify-center mb-8">
            <div className="w-80 h-80 rounded-3xl flex items-center justify-center shadow-2xl overflow-hidden bg-white dark:bg-slate-700 p-5">
              <img
                src="/logoLMM.PNG"
                ...
                onError={(e) => {
                  ...
                  e.currentTarget.parentElement!.classList.add('bg-gradient-to-br', 'from-primary-500', 'to-primary-700', 'text-white', 'text-9xl');
                }}
              />
            </div>
          </div>
